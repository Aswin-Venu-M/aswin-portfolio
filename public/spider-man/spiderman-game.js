...
var RESOURCES_FOLDER_PATH = "/spider-man/";
...
SpidermanGame.prototype.showPauseMenu = function() {
	...
	this.pauseMenu.style.left = (canvasRect.left + canvasRect.width  / 2) + "px";
	this.pauseMenu.style.top  = (canvasRect.top  + canvasRect.height / 2) + "px";
}
...
SpidermanGame.prototype.showGameoverMenu = function() {
	...
	this.gameoverMenu.style.left = (canvasRect.left + canvasRect.width  / 2) + "px";
	this.gameoverMenu.style.top  = (canvasRect.top  + canvasRect.height / 2) + "px";
}
